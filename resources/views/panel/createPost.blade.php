...
@section("body")
    <div class="container d-flex flex-columns">
        ...
        <div class="row">
            ...
            <form action="{{route("post.update" , $userInfo->id)}}" method="POST" id="editProfile" class="d-flex flex-row gap-10">
@csrf
                @method('PUT')
                ...
                <div class=" mt-10 box w25 px-2 py-2 border-s-2" style="flex-basis: 70%;">
                    ...
                    <div class="d-flex flex-columns">
                        <div class="item mb-1"><label for="title" class="d-block">title</label>
                            <input type="text" name="title" value="{{$userInfo->title}}" id="title" placeholder="please enter your title of post"
                                   class="w100 py-1  mt-1">
                        </div>
                        <div class="item mb-1"><label for="slug" class="d-block">slug</label>
                            <input type="text" name="slug" value="{{$userInfo->slug}}" id="slug" placeholder="please enter your slug"
                                   class="w100 py-1  mt-1">
                        </div>
